...
<head>
    ...
    <title>Pengaturan Petugas - KampusResik</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="h3 fw-bold mb-0">Pengaturan Petugas</h2>
                ...
                <div class="card settings-card p-4 p-md-5">
                    ...
                    <form action="proses_pengaturan.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-teal w-100 py-2 fw-bold text-white" style="background-color: #0d9488;">
                            Simpan Perubahan
                        </button>
                    </form>
                </div>
